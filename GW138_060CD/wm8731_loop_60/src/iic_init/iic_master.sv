...
module iic_master #(
    ...
    output              o_send_busy,
    output logic        o_send_en_ack = 1'b0, //发送使能应答：IDLE 收到 i_send_en 时拉高一个时钟
    output logic        o_send_done   = 1'b0, //一笔事务完成：回到 IDLE 时拉高一个时钟
...
logic sda_en  = 1'b1;
logic sda_out = 1'b1;
logic [P_CLK_FRE / 2_000_000 : 0] sda_out_r = 'd0;
logic [P_CLK_FRE / 2_000_000 : 0] sda_en_r  = 'd0;
...
logic [15:0] slave_addr_r = 'd0;
logic [15:0] reg_addr_r   = 'd0;
