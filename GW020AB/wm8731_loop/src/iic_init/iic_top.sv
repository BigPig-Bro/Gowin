//IIC 初始化控制器：上电延时后按 LUT 表逐条配置从机寄存器
//220901    v1.0.0   初始版本
//260919    v1.1.0   修复寄存器地址滞后一行：改为事务完成后装载下一条
//260919    v1.2.0   事务完成改用 iic_master 的 o_send_done，删除本地 busy 打拍
